      ...
      <div class="panel" appReveal>
        ...
        <div class="term">
          ...
          <div class="term-body mono">
            ...
            <p class="tl out"><span class="ok">✔</span> {{ profile.availability }}</p>
            <p class="tl out"><span class="ok">✔</span> {{ links.location }} · remote-friendly · {{ profile.timezone }}</p>
            ...
            <p class="tl"><span class="prompt">akash&#64;portfolio</span>:<span class="path">~</span>$ <span class="blink-caret"></span></p>
          </div>
        </div>
      </div>
    </section>
